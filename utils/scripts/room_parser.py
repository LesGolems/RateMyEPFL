...
def retrieve_rooms(building):
    ...
    rooms = set()
    driver = webdriver.Chrome(executable_path='C:/Users/Souly/Bureau/chromedriver.exe') # change with your own chrome driver path, or any other browser supported by selenium
    driver.get(url)
